...
const VIEWS = [
  ...
  {
    num: '03', label: 'Integrated Rhythm', title: '루틴과 할 일을 분리하지 마세요.',
    body: '매일의 습관과 오늘 끝내야 할 일은 결국 하나의 리듬입니다. 캘린더 뷰에서 루틴과 투두를 통합 관리하세요. 루틴을 챙기느라 중요한 일을 놓치거나, 바쁜 업무에 치여 나만의 습관을 포기할 필요가 없습니다.',
    demo: 'calendar-view',
  },
  {
