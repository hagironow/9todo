...
## 사용법
- 새 링크 필요하면 `/utm 채널명` 실행
- Cloudflare Pages 배포 시 `public/_redirects` 자동 적용
...
- 첫 글자(들): 소스 (k=kakao, th=threads, m=meta, l=linkedin, rd=reddit, d=disquiet, inf=influencer, r=referral)
- 숫자: 순번 (같은 소스의 여러 캠페인 구분)
